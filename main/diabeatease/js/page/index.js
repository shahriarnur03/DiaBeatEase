    ...
    $(document).ready(function() {
        ...
        var options = {
            series: [{
                ...
                name: 'Fracture Risk and Bone Fragility',
...
// for pie chart
    $(document).ready(function() {
      ...
      colors: ['#B5C7C3', '#F7B36A', '#669DB5'],
      labels: ["Children", "Male", "Female"],
      plotOptions: {
        pie: {
          dataLabels: {
            offset: -20,
      ...
      //   opacity: 0.85,
      //   image: {
      //     src: ['assets/images/xs/avatar3.jpg', 'assets/images/xs/avatar3.jpg', 'assets/images/xs/avatar3.jpg'],
      //     width: 25,
      //     imagedHeight: 25
      //   },
      // },
